        ...
        <div className="flex flex-col h-[99vh] w-full text-black bg-white rounded-md shadow-sm p-5 overflow-y-auto">
            ...
            <div className="pt-5 pb-5">
                ...
                <div className="w-100 grid grid-cols-2 gap-5">
                    <div className="group flex flex-col hover:text-[#6581FF] h-50 w-50 border border-black/10 rounded-md cursor-pointer p-5">
                    ...
                    <div className="flex flex-col hover:text-[#6581FF] h-50 w-50 border border-black/10 rounded-md cursor-pointer p-5">
